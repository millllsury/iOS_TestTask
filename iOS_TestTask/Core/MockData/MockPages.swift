...
enum MockPages {
    ...
    static let data: [Page] = [
        ...
        Page(id: "page-waterfall",
             ...
             items: [
                ListItem(id: "waterfall-water", title: localized("item.waterfall.water.title"), description: localized("item.waterfall.water.description"), imageName: "img1"),
        ...
        Page(id: "page-forest",
             ...
             items: [
                ...
                ListItem(id: "forest-horse", title: localized("item.forest.horse.title"), description: localized("item.forest.horse.description"), imageName: "img7"),
                ListItem(id: "waterfall-water", title: localized("item.waterfall.water.title"), description: localized("item.waterfall.water.description"), imageName: "img1"),
                ListItem(id: "waterfall-air", title: localized("item.waterfall.air.title"), description: localized("item.waterfall.air.description"), imageName: "img8"),
                ListItem(id: "waterfall-fresh", title: localized("item.waterfall.fresh.title"), description: localized("item.waterfall.fresh.description"), imageName: "img9"),
                ListItem(id: "forest-wind1", title: localized("item.forest.wind.title"), description: localized("item.forest.wind.description"), imageName: "img10"),
                ListItem(id: "forest-valley1", title: localized("item.forest.valley.title"), description: localized("item.forest.valley.description"), imageName: "img11"),
                ListItem(id: "forest-horse1", title: localized("item.forest.horse.title"), description: localized("item.forest.horse.description"), imageName: "img7"),
                ListItem(id: "waterfall-water1", title: localized("item.waterfall.water.title"), description: localized("item.waterfall.water.description"), imageName: "img1"),
                ListItem(id: "waterfall-air1", title: localized("item.waterfall.air.title"), description: localized("item.waterfall.air.description"), imageName: "img8"),
                ListItem(id: "waterfall-fresh1", title: localized("item.waterfall.fresh.title"), description: localized("item.waterfall.fresh.description"), imageName: "img9")
             ])
    ]
}
